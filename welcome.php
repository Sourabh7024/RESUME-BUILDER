...
$sql = "SELECT id,email,image,name FROM `profiles` WHERE `username` LIKE '$username'";
...
<div class="container mt-5">
  ...
  <div class="row mt-5">
    <div class="col-md-12">
      <h2>About Me</h2>
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam dignissim semper justo, id dignissim nisi
        molestie in. Donec faucibus justo at ante finibus interdum. Aliquam suscipit, risus eu efficitur varius, lectus
        velit lobortis odio, vel euismod justo tortor vitae mauris. Integer blandit enim quis tortor facilisis, sed
        facilisis massa convallis. Fusce efficitur felis sed posuere mollis. Morbi dictum luctus orci, quis consequat
        velit tincidunt id. Etiam eget gravida leo. In hac habitasse platea dictumst.</p>
    </div>
  </div>
  <!-- ///////////////////////////////////////////////////////////////////////////////////////////////// -->
  <div class="row mt-5">
